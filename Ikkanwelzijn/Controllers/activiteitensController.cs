...
namespace Ikkanwelzijn.Controllers
{
    public class activiteitensController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "activiteitid,activiteitnaam,activiteitdatum,activiteitplaats,clienten_clientid,organisatie_organisatieid,url,categorie")] activiteiten activiteiten)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "activiteitid,activiteitnaam,activiteitdatum,activiteitplaats,clienten_clientid,organisatie_organisatieid,url,categorie")] activiteiten activiteiten)
        {
            if (ModelState.IsValid)
            {
